...
public class PlanController {
    ...
    @GetMapping("/list")
    public ResponseEntity<List<PlanListGetFromTravelDto>> getPlanList(@RequestParam Long travelId) {
    ...
    public ResponseEntity<Long> updatePlan(@PathVariable Long planId, @RequestBody PlanUpdateDto planDto){
    ...
    public ResponseEntity<Boolean> changePlanStart(@PathVariable Long planId, @RequestBody PlanUpdateDto planDto){
