...
public class TicketController {
    ...
    @PostMapping
    public ResponseEntity<?> createTicket(@RequestBody TicketPostDto ticketDto, @RequestParam Long travelId){
        Long createTicketId = ticketService.createTicket(ticketDto, travelId);
