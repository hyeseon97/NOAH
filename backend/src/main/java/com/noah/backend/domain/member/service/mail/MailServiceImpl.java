...
import com.noah.backend.global.exception.member.FailedMessageTransmissionException;
import com.noah.backend.global.exception.member.InvalidAuthCodeException;
import com.noah.backend.global.util.CookieUtil;
import com.noah.backend.global.util.RedisUtil;
...
public class MailServiceImpl implements MailService {
    ...
    private String createMailContent(int authCode) {
        return "<html>" +
            ...
            "<h2>NOAH: NOAH에 오신 것을 진심으로 환영합니다!</h2>" +
            "<p>저희 NOAH에 가입해 주셔서 감사드립니다. NOAH와 함께 여행을 계획하고 떠나보세요!! :) </p>" +
            "<br>" +
