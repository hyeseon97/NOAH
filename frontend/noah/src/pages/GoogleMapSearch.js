...
const containerStyle = {
  ...
  const Review = ({ review }) => {
    ...
    return (
      <div key={review.id} onClick={toggleExpand} style={{ cursor: "pointer" }}>
    ...
    return (
      <Slider {...settings}>
        {photos.map((photo, index) => (
          <div key={index} style={{ width: "100%", height: "100%", objectFit: "cover" }}>
            <img src={photo.getUrl({ maxWidth: "400", maxHeight: "400", height:"400", width:"400" })} alt="장소 사진" />
  ...
  return (
    <div className="test" style={myStyle}>
      ...
      <div>
        ...
        <div style={{ width: "400px", maxWidth: "100%", margin: "0 auto", alignItems: "center", justifyContent:"center"}}>
